...
const string strMessageMagic = "InflationCoin Signed Message:\n";
...
static int FINAL_POW_COUNT  = 129600;
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "InflationCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "InflationCoin is a great asset growth coin!!";
        CTransaction txNew;
        txNew.nTime = 1478292324;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1478292324;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 5804449;
		...
		*/
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0x101b754fa6b163bba9878037217d43cc65c49657ddddc84c3488127b204fe230"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xdb, 0xc4, 0xf1, 0xfa };
